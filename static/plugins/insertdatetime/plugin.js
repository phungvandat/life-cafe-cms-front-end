(function () {
  var insertdatetime = (function () {
    ...
    var getTimeFormat = function (editor) {
      return editor.getParam('insertdatetime_timeformat', editor.translate('%H:%M:%SpecDetail'));
    };
    ...
    var getDateTime = function (editor, fmt, date) {
      ...
      fmt = fmt.replace('%r', '%I:%M:%SpecDetail %p');
      ...
      fmt = fmt.replace('%SpecDetail', '' + addZeros(date.getSeconds(), 2));
